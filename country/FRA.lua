...
function P.Build_infantry_brigade(vIC, viManpowerTotal, voType, voProductionData, viUnitQuantity)
	-- Build old style formations till 1939
	if voProductionData.Year < 1938 and not(voProductionData.IsAtWar) and not(voProductionData.IsExile) then
